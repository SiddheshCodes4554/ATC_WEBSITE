  ...
  return (
    <div className="min-h-screen bg-[#FAF7F0] paper-pattern pb-24 select-none relative overflow-hidden">
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        {/* EVENT PHOTO GALLERY & MEMORIES SCRAPBOOK */}
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h3 className="font-black text-xl text-[#121316]">
                    Event Memories & Photo Scrapbook ({event.galleryImageIds.length})
                  </h3>
                  <p className="font-mono text-xs text-gray-500 font-bold">
                    Moments, team pitches, hackathon energy, and stage snapshots
                  </p>
                </div>
              </div>
            </div>
