...
interface ThreePathsSectionProps {
  onSelectPath?: (path: 'community' | 'partner') => void;
}
...
// Vector Illustration 2: Partners & Speakers
  ...
  return (
    <section className="relative bg-[#FAF7F0] py-20 paper-pattern border-b-4 border-[#121316] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 2 Distinct Path Cards Grid (Side by side on desktop, stacked on mobile) */}
          ...
          {paths.map((path) => (
            ...
            >
              ...
              <div>
                ...
                <div className="mb-4">
                  <span
                    className={`px-4 py-1 rounded-full font-mono font-black text-xs uppercase border-2 border-[#121316] shadow-pop-sm inline-block ${path.badgeBg}`}
                  >
                    {path.tagline}
                  </span>
                </div>
                ...
                <div className="space-y-2 mb-8 p-4 bg-white/70 rounded-2xl border-2 border-[#121316]/20">
                  ...
                  {path.perks.map((perk) => (
                    <div
                      key={perk}
                      className="flex items-start gap-2 text-xs sm:text-sm font-bold text-gray-800"
                    >
