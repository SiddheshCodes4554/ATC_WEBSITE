  ...
  const paths = [
    {
      ...
      desc: 'For students who want to participate in workshops, compete in hackathons, use Lab 502 benches, and meet fellow tech enthusiasts.',
      perks: [
        'Free entry to all campus hackathons',
        'Access to workshop repos & slides',
        'Official WhatsApp & Discord community',
        'Lab 502 weekend open hours',
      ],
