...
export const AdminDashboardPage: React.FC = () => {
  ...
  const adminModules = [
    ...
    },
    {
      ...
      desc: 'Review incoming 1st and 2nd year student membership applications for the core cohort, review academic info, and approve/reject candidates.',
      icon: <Users className="w-6 h-6 stroke-[2.5]" />,
      iconVariant: 'purple' as const,
      badge: 'APPLICATIONS (APPROVAL REQUIRED)',
      color: 'bg-[#FAF7F0]',
    ...
    },
    {
      ...
      desc: 'View all students registered with ATC accounts. Accounts are active instantly upon signup with zero approval required.',
      icon: <Users className="w-6 h-6 stroke-[2.5]" />,
      iconVariant: 'purple' as const,
      badge: 'USERS (NO APPROVAL NEEDED)',
      color: 'bg-[#E1DCFF]',
